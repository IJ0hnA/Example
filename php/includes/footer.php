			...
			<div class="container text-center text-md-left mt-5">
				...
				<div class="row mt-3">
					...
					<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
						...
						<p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas distinctio harum veritatis at tempore aliquid deleniti explicabo iusto provident. Commodi iste dolorem maxime magnam illum enim! Facere quasi veritatis qui.</p>
